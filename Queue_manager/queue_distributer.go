...
func Update_outside_order(External_order Network.Message, Broadcast_buffer chan Network.Message,local_queue_chan chan Types.Order_queue) {
...
func Update_inside_order(floor int,state int,Broadcast_buffer chan Network.Message,local_queue_chan chan Types.Order_queue){
...
func Get_orders(Received_order_ch,Broadcast_buffer chan Network.Message,Queue_Network_chan chan map[string]Types.Order_queue,local_queue_chan chan Types.Order_queue){ //STILL IN PRODUCTION, how is the queue going to be
...
func assign_order(floor int,order_type int,Queue_Network_chan chan map[string]Types.Order_queue,local_queue_chan chan Types.Order_queue)(bool,Network.Message){
...
func Redistribute_orders(External_order Network.Message,Broadcast_buffer chan Network.Message,Queue_Network_chan chan map[string]Types.Order_queue,local_queue_chan chan Types.Order_queue){
