...
func stop_routine(current_direction,current_floor int,Broadcast_buffer chan Network.Message,local_queue_chan chan Types.Order_queue) {
...
func Update_queue(current_direction,current_floor int,state int,Broadcast_buffer chan Network.Message,local_queue_chan chan Types.Order_queue){
...
func Run_elevator(Broadcast_buffer chan Network.Message,current_floor int,local_queue_chan chan Types.Order_queue){
